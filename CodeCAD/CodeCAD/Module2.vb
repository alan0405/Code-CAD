...
#Region "   基本参数列表"
    ...
    '轴距
    Private Const AxDistance As Double = 60
...
#End Region
    ...
    Private Sub DrawMoShell()
        ...
        '底部孔
        Dim holeCy = Cylinder(LineDiameter, ShellThickness, P(basePoint, 10, 0, -baseHight))
        '组合
        Union(body, fastener)
    ...
    Private Sub ShellCover()
        ...
        Dim m2fs = ArrayPolar(m2f, 8, -180, P(basePoint, MoAxOffset + AxDistance, 0, 2))
        ...
        Subtraction(body, m2f, m2f1, m2f2, m2f3, m2f4)
        Subtraction(body, m2fs)


        Dim pPuOut() As Double = P(MoAxOffset + AxDistance)
        'Dim e = Msp.AddCircle(pPuOut, 11)
        Dim c = Cube(100, 100, 100, P(pPuOut, PuDiameter / 2))
        Rotate3D(c, pPuOut, RotateAX.z, -11)
        Dim c1 = ArrayPolar(c, 10, -60, pPuOut)
        Subtraction(body, c)
        Subtraction(body, c1)
    End Sub
    ...
    Private Sub PuShell()
        ...
        Dim m2fs = ArrayPolar(m2f, 8, -180, P(basePoint, MoAxOffset + AxDistance, 0, 0))
        ...
        Dim m2f3 = CopyTo(m2f2, P(8))
        Dim m2f4 = CopyTo(m2f3, P(8))
        Union(body, m2f, m2f1, m2f2, m2f3, m2f4)
        Union(body, m2fs)
